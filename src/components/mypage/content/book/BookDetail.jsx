...
import { Menu, Header, Label, Image, Table } from "semantic-ui-react";
      ...
      <Table basic="very">
        <Table.Body>
          <Table.Row>
            ...
            <Table.Cell>
              <Header as="h5">
                <Header.Content>Harry Potter</Header.Content>
              </Header>
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            ...
            <Table.Cell>
              <Header as="h5">
                <Header.Content>J.K Rollings</Header.Content>
              </Header>
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            ...
            <Table.Cell>
              <Header as="h5">
                <Header.Content>Novel</Header.Content>
              </Header>
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            ...
            <Table.Cell>
              <Header as="h5">
                <Header.Content>Reading</Header.Content>
              </Header>
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            ...
            <Table.Cell>
              <Header as="h5">
                <Header.Content>55%</Header.Content>
              </Header>
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            ...
            <Table.Cell>
              <Header as="h5">
                <Header.Content>10/31/2019</Header.Content>
              </Header>
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            ...
            <Table.Cell>
              <Header as="h5">
                <Header.Content>11/30/2019</Header.Content>
              </Header>
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            ...
            <Table.Cell>
              <Header as="h5">
                <Header.Content>12/31/2019</Header.Content>
              </Header>
            </Table.Cell>
          </Table.Row>
          <Table.Row>
